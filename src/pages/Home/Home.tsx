...
export const Home = () => {
  ...
  const preparedTests = getPreparedTests(tests, query);
  ...
  const onOpenTest = (testId: number) => {
                ...
                >
                  {(provided) => (
                    ...
                    >
                      ...
                      {!user?.testsResults.find(r => r.testId === test.id) ? (
                        <button className="btn btn-success" onClick={() => onOpenTest(test.id)}>
                          Open
                        </button>
                      ) : (
                        <p>
